...
<script type="text/javascript" src="<?php print $_layoutParam["caminho_vendores"] ?>datatables/js/jquery.dataTables.min.js"></script>
<script type="text/javascript" src="<?php print $_layoutParam["caminho_vendores"] ?>datatables/js/jquery.dataTables.bootstrap.min.js"></script>
<script type="text/javascript" src="<?php print $_layoutParam["caminho_vendores"] ?>datatables/js/dataTables.tableTools.min.js"></script>
<script type="text/javascript" src="<?php print $_layoutParam["caminho_vendores"] ?>datatables/js/dataTables.colVis.min.js"></script>
...
<script type="text/javascript" src="<?php print $_layoutParam["caminho_assets"] ?>js/holder.js"></script>

<script type="text/javascript" src="<?php print $_layoutParam["caminho_assets"] ?>js/jquery.validate.min.js"></script>
